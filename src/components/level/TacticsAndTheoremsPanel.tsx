      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Theorem Details</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto flex-1">
          <div className="space-y-4">
            {/* Theorem Name */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-2">Theorem Name</h3>
              <code className="text-sm font-mono text-gray-900 bg-gray-50 p-2 rounded block">
                {theoremName}
              </code>
            </div>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-2">Type / Description</h3>
              <div className="bg-gray-50 p-3 rounded">
                <code className="text-sm font-mono text-gray-900 whitespace-pre-wrap break-words">
                  {theoremType || theorem}
                </code>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-success-50 border border-success-200 p-3 rounded">
                <pre className="text-xs font-mono text-success-900 whitespace-pre-wrap">
                  {example}
                </pre>
              </div>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="flex items-center space-x-2 p-4 border-b border-gray-200">
            ...
            <h3 className="font-semibold text-gray-900">Tactics Unlocked</h3>
          </div>
          <div className="p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
              {unlockedTactics.map((tactic, idx) => (
                <div
                  key={idx}
                  className="bg-primary-50 border border-primary-200 rounded p-1.5 text-center"
                >
                  <code className="text-[10px] font-mono text-primary-900 break-words leading-tight">{tactic}</code>
                </div>
              ))}
            </div>
            )}
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="flex items-center space-x-2 p-4 border-b border-gray-200">
            <BookOpen className="text-success-600" size={20} />
            <h3 className="font-semibold text-gray-900">Theorems Available</h3>
          </div>
          <div className="p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
                {availableTheorems.map((theorem, idx) => (
                  <button
                    ...
                    className="bg-success-50 border border-success-200 rounded p-1.5 text-center hover:bg-success-100 hover:border-success-300 transition-colors cursor-pointer"
                  >
                    <code className="text-[10px] font-mono text-success-900 break-words leading-tight">
